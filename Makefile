...
clean:
	@rm -rf dist deb-build release-builds flatpak-build .flatpak-builder zip-build SafeSurfer-Desktop*.zip *.AppImage nz.co.safesurfer.SafeSurfer-Desktop.AppDir $(DESTDIR) SafeSurfer-Desktop.snapbuild dist safesurfer-desktop_*_*.snap
