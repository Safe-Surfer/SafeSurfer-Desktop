...
SetupIconFile=CURRENTDIRECTORY\assets\media\icons\win\icon.ico
Compression=lzma
...
[Files]
Source: "CURRENTDIRECTORY\release-builds\SafeSurfer-Desktop-win32-x64\safesurfer-desktop.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "CURRENTDIRECTORY\release-builds\SafeSurfer-Desktop-win32-x64\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
