...
AppVersion=1.0.0rc4
;AppVerName=SafeSurfer-Desktop 1.0.0rc4
...
SetupIconFile=Z:\root\build\SafeSurfer-Desktop-1.0.0rc4\assets\media\icons\win\icon.ico
Compression=lzma
...
[Files]
Source: "Z:\root\build\SafeSurfer-Desktop-1.0.0rc4\release-builds\SafeSurfer-Desktop-win32-ia32\safesurfer-desktop.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "Z:\root\build\SafeSurfer-Desktop-1.0.0rc4\release-builds\SafeSurfer-Desktop-win32-ia32\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
